	...
	var SubmitForm = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					"form",
					{ style: style, onSubmit: this.submit },
					...
					React.createElement(EditBox, { desc: "\u6587\u7AE0Selector:", updateField: this.updateField, type: "text", field: "entry", value: this.state.entry }),
					React.createElement(EditBox, { desc: "\u6807\u9898Selector:", updateField: this.updateField, type: "text", field: "item_title", value: this.state.item_title }),
					React.createElement(EditBox, { desc: "\u94FE\u63A5Selector:", updateField: this.updateField, type: "text", field: "item_link", value: this.state.item_link }),
					React.createElement(EditBox, { desc: "\u5185\u5BB9Selector:", updateField: this.updateField, type: "text", field: "item_content", value: this.state.item_content }),
	...
	var App = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				null,
				React.createElement(Title, { title: "\u6DFB\u52A0\u8BA2\u9605\u6E90(Blog)" }),
